...
const MakeUpArtistSub=()=> {
    ...
    const jobPosts = [
        ...
        {
            id: '2',
            profession: 'ASSISTANT MAKEUP ARTIST',
        },
        {
            id: '3',
        ...
        {
            id: '4',
            profession: 'ASSISTANT HAIR STYLIST',
        },
    ...
    const handleOnPress = (item) => {
        const newItem = select.map((value) => {
            if (item.profession == 'MAKEUP ARTIST') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'ASSISTANT MAKEUP ARTIST') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'HAIR STYLIST') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'ASSISTANT HAIR STYLIST') {
                return (
                    navigation.navigate("Director")
                )
            }
...
export default MakeUpArtistSub;
