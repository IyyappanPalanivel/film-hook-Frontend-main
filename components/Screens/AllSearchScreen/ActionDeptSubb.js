...
const ActionDeptSubb=()=> {
    const navigation = useNavigation();
    const jobPosts = [
        {
            id: 1,
            profession: 'STUNT MASTER',
        },
        {
            id: '2',
            profession: 'FIGHT MASTER',
        },
        {
            id: '3',
            profession: 'BOXING TRAINER',
        },
       
        {
            id: '4',
            profession: 'FITNESS MASTER',
        },
        {
            id: '5',
    ...
    const handleOnPress = (item) => {
        const newItem = select.map((value) => {
            if (item.profession == 'STUNT MASTER') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'FIGHT MASTER') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'BOXING TRAINER') {
                return (
                    navigation.navigate("Director")
                )
            }
            
            if (item.profession == 'FITNESS MASTER') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'ACTION DIRECTOR') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'STUNT PERFORMER') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'STUNT MAN') {
                return (
                    navigation.navigate("Director")
                )
            }
