...
const VfxSub=()=> {
    ...
    const jobPosts = [
        ...
        {
            id: '2',
            profession: 'VFX CREATOR',
        },
        {
            id: '3',
            profession: 'COLOURIST',
        },
    ...
    const handleOnPress = (item) => {
        const newItem = select.map((value) => {
            if (item.profession == 'VFX EDITOR') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'COLOURIST') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'VFX CREATOR') {
                return (
                    navigation.navigate("Director")
                )
            }
