...
const CostumeSub=()=> {
    ...
    const jobPosts = [
        ...
        {
            id: '2',
            profession: 'ASSISTANT COSTUME DESIGNER',
        },
        {
            id: '3',
            profession: 'ASSOCIATE COSTUME DESIGNER',
        },
    ...
    const handleOnPress = (item) => {
        const newItem = select.map((value) => {
            if (item.profession == 'COSTUME DESIGNER') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'ASSISTANT COSTUME DESIGNER') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'ASSOCIATE COSTUME DESIGNER') {
                return (
                    navigation.navigate("Director")
                )
            }
