...
const LightingDeptSub=()=> {
    ...
    const jobPosts = [
        ...
        {
            id: '2',
            profession: 'LIGHTING TECHNICAL DIRECTOR',
        },
    ...
    const handleOnPress = (item) => {
        const newItem = select.map((value) => {
            if (item.profession == 'SET BOYS') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'LIGHTING TECHNICAL DIRECTOR') {
                return (
                    navigation.navigate("Director")
                )
            }
...
export default LightingDeptSub;
