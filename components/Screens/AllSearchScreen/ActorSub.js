...
const ActorSub=()=> {
    ...
    const jobPosts = [
        ...
        {
            id: '4',
            profession: 'SUPPORTING ARTIST',
        },
        {
            id: '5',
            profession: 'JUNIOR ARTIST CLASS',
        },
    ...
    const handleOnPress = (item) => {
        const newItem = select.map((value) => {
            if (item.profession == 'HERO') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'HEROINE') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'CHARACTER ARTIST') {
                return (
                    navigation.navigate("Director")
                )
            }
            
            if (item.profession == 'SUPPORTING ARTIST') {
                return (
                    navigation.navigate("Director")
                )
            }

            if (item.profession == 'JUNIOR ARTIST CLASS') {
                return (
                    navigation.navigate("Director")
                )
            }
