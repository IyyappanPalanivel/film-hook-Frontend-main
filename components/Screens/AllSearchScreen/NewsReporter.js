...
const NewsReporter = () => {
    ...
    const jobPosts = [
        ...
        {
            id: '35',
            profession: 'VIDEO JOCKEY',

           // companyLogo: require('../../Assets/AllSearch_Icon_And_Fonts/Filmhook-Screenshot_2023-11-13_085839-removebg-preview.png'),
        },
        {
            id: '36',
            profession: 'PRESS DEPARTMENT',
    ...
    const handleOnPress = (item) => {
        const newItem = select.map((value) => {
            if (item.profession == 'ANCHORS') {
                return (
                    navigation.navigate("Director")
                )
            }
            else if (item.profession == 'VIDEO JOCKEY') {
                return (
                    navigation.navigate("Director")
                )
            }
            else if (item.profession == 'PRESS DEPARTMENT') {
                return (
                    navigation.navigate("Director")
                )
            }
            else if (item.profession == 'JOURNALIST') { // DOUBT FOR IS REMOVE OR NOT
                return (
                    navigation.navigate("Director")
                )
            }
