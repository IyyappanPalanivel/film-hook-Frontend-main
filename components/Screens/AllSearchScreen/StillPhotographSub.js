...
const StillPhotographSub=()=> {
    ...
    const jobPosts = [
        ...
        {
            id: '2',
            profession: 'ASSISTANT STILL PHOTOGRAPHER',
        },
        {
            id: '3',
            profession: 'STILL PHOTOGRAPHER BEHIND SCENES',
        },
    ...
    const handleOnPress = (item) => {
        const newItem = select.map((value) => {
            if (item.profession == 'STILL PHOTOGRAPHER') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'ASSISTANT STILL PHOTOGRAPHER') {
                return (
                    navigation.navigate("Director")
                )
            }
            if (item.profession == 'STILL PHOTOGRAPHER BEHIND SCENES') {
                return (
                    navigation.navigate("Director")
                )
            }
...
export default StillPhotographSub;
